...
export default function Navbar() {
  ...
  return (
    <div className="relative bg-emerald-950 shadow-lg z-10 bg-ranky-texture bg-[length:80px] bg-repeat opacity-10 z-10 shadow-xl">
      <nav className="px-6 md:container md:mx-auto md:px-8 py-4 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 md:gap-3">
          <img
            src="/ranky-logo.png"
            alt="Ranky logo"
            className="w-8 h-8 md:w-10 md:h-10 rounded-full opacity-100"
          />
          <span className="text-xl opacity-100 md:text-3xl font-black tracking-tight bg-gradient-to-r from-yellow-400 via-yellow-300 to-gray-300 text-transparent bg-clip-text">
            Ranky
          </span>
        </Link>

        <div className="flex items-center gap-3 md:gap-4 opacity-100">
