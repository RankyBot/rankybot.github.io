  ...
  return (
    <nav className="px-6 md:container md:mx-auto md:px-8 py-4 flex items-center justify-between relative z-10">
      ...
      >
        ...
        />
        <span className="text-xl md:text-3xl font-black tracking-tight bg-gradient-to-r from-yellow-400 via-yellow-300 to-gray-300 text-transparent bg-clip-text transition-shadow duration-300 group-hover:shadow-[0_0_8px_2px_rgba(255,255,255,0.5)]">
          Ranky
        </span>
      </Link>
      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <a
          ...
          className="bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-50 text-amber-900 font-semibold px-3 md:px-4 py-2 rounded hover:brightness-110 hover:shadow-[0_0_12px_2px_rgba(255,255,255,0.5)] transition-all duration-400 text-sm md:text-base"
        >
