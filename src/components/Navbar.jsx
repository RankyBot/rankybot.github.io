...
export default function Navbar() {
  ...
  return (
    <nav className="px-6 md:container md:mx-auto md:px-8 py-4 flex items-center justify-between relative z-10">
      <Link to="/" className="flex items-center gap-2 md:gap-3 shadow-xl hover:brightness-110 hover:border-solid-white transition-all duration-200">
        <img
          src="/ranky-logo.png"
          alt="Ranky logo"
      ...
      <div className="flex items-center gap-3 md:gap-4">
        ...
        <a
          ...
          className="bg-gradient-to-r from-yellow-200 via-yellow-100 to-yellow-50 text-amber-900 font-semibold px-3 md:px-4 py-2 rounded hover:brightness-110 hover:border-solid-amber-600 hover:shadow-lg transition-all duration-200 text-sm md:text-base"
        >
